...
class DetailArticleViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellTwo", for: indexPath) as! DetailTableViewCell
        
        cell.detailImageView.image = UIImage(named: "image")
        cell.detailDateLabel.text = "14 февраля"
        cell.detailLikeButton.imageView?.image = UIImage(named: "likeImage")
        cell.detailArticleLabel.text = "Название"
        cell.detailArticleText.text = """
...
//  NewsTestApp
//
//  Created by Арсентий Халимовский on 07.03.2023.
//
